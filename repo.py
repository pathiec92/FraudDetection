...
class Gcloud:
    ...
    def sendSms(self,name,token):
        ...
        sms = u"https://www.businesssms.co.in/sms.aspx?ID=satyology@gmail.com&Pwd=Nastssms@2328&PhNo={}&Text=Your Vehicle No. {} Door Opened at {} and you can view/ download video clip at {}" \
